...
namespace KretaDesktop.Extensions
{
    public static class ViewViewModelsExtensions
    {
        public static void ConfigureViewViewModels(this IServiceCollection services)
        {
            ...
            // HeadTeacher
            services.AddSingleton<HeadTeacherViewModel>();
            services.AddSingleton<HeadTeacherView>(s => new HeadTeacherView()
            {
                DataContext = s.GetRequiredService<HeadTeacherViewModel>()
            });
